...
namespace Bankers_Algorithm
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            DialogResult result = MessageBox.Show("Bạn có muốn xoá không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
        ...
        private void rich_allocation_TextChanged(object sender, EventArgs e)
        {

        }

        private void text_available_TextChanged(object sender, EventArgs e)
        {
        ...
        private void rich_need_TextChanged(object sender, EventArgs e)
        {

        }

        private void rich_output_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            DialogResult result = MessageBox.Show("Bạn có muốn thoát không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
            if (result == DialogResult.Yes)
            {
                Application.Exit(); 
            }
